...
- Name: scorekeeping-page.spec.ts >> Scorekeeping Page >> Accessibility >> should be keyboard navigable
- Location: tests/e2e/scorekeeping-page.spec.ts:73:9
...
- generic [ref=e1]:
  - main [ref=e2]:
    - region "Game timer control" [ref=e3]:
      ...
      - button "Start timer" [active] [ref=e8]:
        - img [ref=e9]
